...
| Подход               | Device | RAM Usage (MB) | VRAM Usage (MB) | Avg Time (ms) | WER   | CER   |
| ---------------------- | ------ | -------------- | --------------- | ------------- | ----- | ----- |
| Whisper (Transformers) | CPU    | 1108.5         | –               | 4011.82       | 1.27% | 1.03% |
| Whisper (Transformers) | GPU    | –              | 922.88          | 694.11        | 1.27% | 1.03% |
| Whisper (ONNX)         | CPU    | 2083.6         | –               | –             | 1.27% | 1.02% |
| Whisper (ONNX)         | GPU    | –              | 1706.88         | –             | 1.27% | 1.02% |
| Whisper (OpenVINO)     | CPU    | 696.20         | –               | 3175.36 ms    | 1.27% | 1.02% |

...
| Модель | Метод | Размер весов | Время инференса (CPU, sec/token) | Время инференса (GPU, sec/token) | Использование RAM (MB) | Использование VRAM (MB) | Качество (NISQA-AVG) | Качество (WER) |
| :---   | :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: |
| FishSpeech| Оригинал | 1280Mb   | 2.38095 (sec/tokens) | 0.08726 (sec/tokens) | 1560Mb | 1560Mb | 2.25+-0.08 | 0.031+-0.028 |

...
| Модель                  | Метод        | Размер весов (МБ) | Время инференса (CPU) | Время инференса (GPU, сек/сэмпл) | Использование RAM (МБ) | Использование VRAM (МБ) | Точность (1 - WER) |
| :---------------------- | :----------- | :---------------- | :--------------------- | :----------------------------------- | :--------------------- | :---------------------- | :----------------- |
| openai/whisper-large-v3 | Оригинал     | **5888.20**       | -                      | 0.9807                               | 265.25                 | 6536.38                 | 0.9327             |
| openai/whisper-large-v3 | ONNX         | 9460.61           | -                      | 0.7684                               | 113.38                 | 6562.14                 | 0.9327             |
